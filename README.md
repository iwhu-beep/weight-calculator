...
- **键盘快捷键** — 输入后按 Enter 自动跳转到下一输入框，快速连续录入
- **语音读数** — 支持中文语音朗读输入数值，可选多种中文语音
- **版本自检** — 启动时静默检查 GitHub Releases 新版本，有新版本时设置按钮显示角标，可一键下载最新 IPA
- **实时结果横幅** — 计算结果有效时顶部吸顶横幅实时显示总重量/色粉数/合计，点击直达详细结果
- **自定义应用图标** — 蓝绿渐变 + 天平标识，CI 构建时自动生成全套 iOS 图标与启动图
